...
export function Gallery() {
  ...
  return (
    <section ref={ref} className={visible ? "reveal in" : "reveal"} style={{ background: "#fff" }}>
      <div className="container section-pad">
        ...
        >
          {/* feature */}
          <figure style={{ margin: 0, gridColumn: "span 12", aspectRatio: "16 / 9", overflow: "hidden", borderRadius: 4 }}>
            <img
          ...
          {/* tall + landscape */}
          <figure style={{ margin: 0, gridColumn: "span 5", aspectRatio: "3 / 4", overflow: "hidden", borderRadius: 4 }}>
            <img src={eventConfig.gallery[3].src} alt={eventConfig.gallery[3].alt} loading="lazy" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
          </figure>
          <figure style={{ margin: 0, gridColumn: "span 7", aspectRatio: "4 / 3", overflow: "hidden", borderRadius: 4 }}>
